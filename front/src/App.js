            ...
            <Route element={<ParentLayout />}>
              ...
              <Route element={<MessageLayout />}>
                <Route path="/messages">
                  ...
                  <Route
                    path=":username"
                    element={<RequireValidUser redirect={"/messages"} />}
                  >
              ...
              <Route
                element={
                  <MainLayout
                    includeRenderWidgets={["SearchBar", "Trending"]}
                  />
                }
              >
        ...
        {background && (
          <Routes>
            <Route Route element={<PrivateRoute />}>
              ...
              <Route path="/compose">{HomeRoutes(background.pathname)}</Route>
