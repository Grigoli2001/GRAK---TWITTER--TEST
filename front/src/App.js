...
// modals as fn
import { ProfileModalRoutes, ProfileEditRoutes } from "./components/profile/ProfileRoutes";
    ...
    <>
          <Routes location={ background || location }>
            ...
            {/* <Route element={<PrivateRoute />}> */}
                <Route element={<TestLayout includeRenderWidgets={['SearchBar', 'WhoToFollow', 'Trending']}/>}>
              ...
              <Route element={<MessageLayout />}>
                ...
                {/* TODO simplify */}
                <Route element={<TestLayout includeRenderWidgets={['SearchBar', 'Trending']}/>}>
                  <Route path="/i/connect-people" element={<Connect />} />
                </Route>

                {/* trends */}
                <Route element={<TestLayout includeRenderWidgets={['SearchBar', 'WhoToFollow']}/>}>
