...
const AfterRegistrationPopup = ({ onClose }) => {
  ...
  const checkUserNameAvailability = async () => {
    ...
    instance
      .post(requests.check, { userInfo: userName })
      .then((res) => {
              ...
              <div className="flex flex-col w-9/12 relative mt-6">
                ...
                {currentPage === 4 && (
                  <>
                    ...
                    <div className="flex flex-col min-h-[360px] max-h-[360px]">
                      {renderLanguages()}
                    </div>
                    <div className="flex justify-center">
                      <button
                  ...
                  <>
                    ...
                    <div className="mt-5 relative">
                      <input
                        ...
                        className={`dark:bg-black dark:text-white w-[300px] h-[60px] rounded-md p-4 pt-7 pl-7 border-gray-300 dark:border-gray-900 border-2 focus:outline-none focus:border-blue-600 transition-all `}
                      />
                      <label
                        htmlFor="email"
